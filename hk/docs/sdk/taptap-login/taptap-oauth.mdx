...
3. 请求 `https://open.tapapis.com/account/profile/v1` ， header 携带 `mac token`。
...
>  <Red> GET </Red> https://open.tapapis.com/account/basic-info/v1?client_id=xxx <br/><Blue> Authorization </Blue> mac token
...
>  <Red> GET </Red> https://open.tapapis.com/account/profile/v1?client_id=xxx <br/><Blue> Authorization </Blue> mac token
