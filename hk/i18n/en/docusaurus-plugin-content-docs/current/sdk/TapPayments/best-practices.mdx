...
**The game backend <Red>must integrate</Red> the [Tap Server Webhook](/sdk/TapPayments/develop/server/#webhook-callback) to <Red>receive refund result notifications</Red>.**
