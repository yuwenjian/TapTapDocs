...
The certificate is a "cert.pem" file applied through the Mobile Security Alliance mailbox [msa@caict.ac.cn](mailto:msa@caict.ac.cn), which corresponds to the package name. Two types of settings are supported.
