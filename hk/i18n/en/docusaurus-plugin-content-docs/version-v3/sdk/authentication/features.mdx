...
- Guest account
- OAuth with TapTap, Apple, Facebook, etc.
...
To allow players to log in with services like TapTap, Apple, and Facebook, you have to obtain an OAuth token from the service provider. If you want to use TapTap Login, please first complete the application process to enable TapTap Login. You can then access the account system on TDS with the OAuth token obtained from TapTap Login.
