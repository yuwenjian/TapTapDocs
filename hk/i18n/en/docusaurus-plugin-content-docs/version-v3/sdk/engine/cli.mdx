...
- Visit [http://localhost:3000](http://localhost:3000) for the homepage of a web application.
- Visit [http://localhost:3001](http://localhost:3001) for the Cloud Function Debug Console (you can debug hooks as well).
...
In the command above, `<REGION>` is the region of the application.
