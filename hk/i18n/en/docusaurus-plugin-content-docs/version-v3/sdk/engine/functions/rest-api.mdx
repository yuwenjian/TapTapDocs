...
The base URL of the REST API is the API domain of your application (represented with `{{host}}`). You can bind and view API domains on the dashboard. See [Domain](/v3/sdk/storage/guide/setup-dotnet/#domain) for more information.

See [this article](/v3/sdk/storage/guide/rest/#request-format) for more information about the format of the request.
