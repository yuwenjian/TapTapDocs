...
See [Hooks and System Conversations](/v3/sdk/im/guide/systemconv/) for more information.
...
3. Run `lean up`. Now you can test your Cloud Functions and hooks on [http://localhost:3001](http://localhost:3001). Once you’re done, run `lean deploy` to deploy your code to Cloud Engine. If you have standard instances, make sure to run `lean publish` as well.
