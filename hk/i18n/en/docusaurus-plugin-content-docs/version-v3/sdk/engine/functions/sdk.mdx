...
The Cloud Engine SDKs for most of the runtime environments are based on the [Data Storage](/v3/sdk/storage/features) SDK, offering additional features that support Cloud Functions and hooks. With the Cloud Engine SDK, you can easily build backend apps that can be deployed to Cloud Engine.
...
Once you have integrated the SDK, you will be able to access the [Data Storage](/v3/sdk/storage/features) service from Cloud Engine to store data. See the articles for Data Storage SDKs for more information.
