...
Log into the [TapTap Developer Center](https://developer.taptap.io/) to register as a developer and create a game.

## Downloading the TapTap App

Download the [TapTap app](https://www.taptap.io/mobile) on your test device. When testing your game, the SDK will take you to the TapTap app for the authorization process. If the TapTap app is not installed on your device, a WebView will be opened for you to log in.
