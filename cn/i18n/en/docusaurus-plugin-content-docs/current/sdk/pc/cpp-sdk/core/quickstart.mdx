...
// TapTap client system state change notification callback function
...
void systemStateNotification(TapEventID eventID, void* data)
{
    // Use TapSystemStateNotification* to cast data type and get state change notification
    // Note: data and other memory referenced inside will be released by the SDK after the callback function returns.
    // If you need to use it for a long time, please make a copy yourself
