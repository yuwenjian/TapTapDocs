...
createRequest.cover_file_path = "/path/to/coverfile";
    // Note: TapCloudSave_AsyncCreate() and TapCloudSave_AsyncUpdate() share a limit of up to 60 calls per minute,
    //       and allow up to 10 concurrent calls, exceeding the limit will return error in callback function
...
**Notes:**
- TapCloudSave_AsyncCreate() and TapCloudSave_AsyncUpdate() share a limit of up to 60 calls per minute, and allow up to 10 concurrent calls
...
updateRequest.cover_file_path = "/path/to/coverfile";
    // Note: TapCloudSave_AsyncCreate() and TapCloudSave_AsyncUpdate() share a limit of up to 60 calls per minute,
    //       allow up to 10 concurrent calls, and the same cloud save cannot be updated concurrently, exceeding the limit will return error in callback function
...
**Notes:**
- TapCloudSave_AsyncCreate() and TapCloudSave_AsyncUpdate() share a limit of up to 60 calls per minute, allow up to 10 concurrent calls, and the same cloud save cannot be updated concurrently
