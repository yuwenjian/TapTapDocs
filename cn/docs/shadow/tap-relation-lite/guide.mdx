...
<CodeBlock language="json">
 {`"dependencies":{
    ...
    "com.taptap.sdk.relationlite":"https://github.com/taptap/TapSDKRelationLite-Unity.git#4.6.1-beta.4",
 }`}
</CodeBlock>
...
`dependencies {
    ...
    implementation 'com.taptap.sdk:tap-relation-lite:4.6.1-beta.4'
}`
}</CodeBlock>
