...
githubDeps={[
{package: "com.taptap.sdk.core", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/Core#${v4SDKVersions.taptap.shadow}`},
{package: "com.taptap.sdk.login", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/Login#${v4SDKVersions.taptap.shadow}`},
{package: "com.taptap.sdk.cloudsave", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/CloudSave#${v4SDKVersions.taptap.shadow}`}
]}
unitypackageModules={[
