...
:::tip
从 TapSDK 4.8.1-beta.1 版本开始支持 PC 端云存档功能，**使用前需接入启动校验**，具体参考 [TapTap PC 端集成](/sdk/access/pc-quickstart/) 文档
:::
...
"com.taptap.tapsdk.unity.cloudsave",
]}
githubDeps={[
{package: "com.taptap.tapsdk.unity.core", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/Core#${v4SDKVersions.taptap.shadow}`},
{package: "com.taptap.tapsdk.unity.login", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/Login#${v4SDKVersions.taptap.shadow}`},
{package: "com.taptap.tapsdk.unity.cloudsave", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/CloudSave#${v4SDKVersions.taptap.shadow}`}
]}
unitypackageModules={[
