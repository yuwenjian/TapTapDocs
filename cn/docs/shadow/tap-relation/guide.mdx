...
<CodeBlock language="json">
  {`"dependencies":{
    ...
    "com.taptap.sdk.relation":"4.6.1-beta.7",
}`}
</CodeBlock>
...
<CodeBlock language="json">
 {`"dependencies":{
    ...
    "com.taptap.sdk.relation":"https://github.com/taptap/TapSDKRelation-Unity.git#4.6.1-beta.7",
 }`}
</CodeBlock>
...
`dependencies {
    ...
    implementation 'com.taptap.sdk:tap-relation:4.6.1-beta.7'
