...
`dependencies {
    implementation 'com.taptap.sdk:tap-core:4.7.0-beta.0'
    implementation 'com.taptap.sdk:tap-leaderboard:4.7.0-beta.0'
    implementation 'com.taptap.sdk:tap-login:4.7.0-beta.0'
}`
}</CodeBlock>
...
```java
import com.taptap.sdk.leaderboard.TapTapLeaderboard;
import com.taptap.sdk.leaderboard.TapTapLeaderboardCallback;
...
```java
import com.taptap.sdk.leaderboard.TapTapLeaderboard;
import com.taptap.sdk.leaderboard.TapTapLeaderboard.ShareCallback;

// 设置分享回调
TapTapLeaderboard.setShareCallback(new TapTapLeaderboard.ShareCallback() {
    @Override
...
// 设置分享回调
TapTapLeaderboard.setShareCallback(object : TapTapLeaderboard.ShareCallback {
...
```java
import com.taptap.sdk.leaderboard.TapTapLeaderboard;
import com.taptap.sdk.leaderboard.LeaderboardDialogArguments;
...
```java
import com.taptap.sdk.leaderboard.TapTapLeaderboard;
import com.taptap.sdk.leaderboard.UserProfileDialogArguments;
...
```java
import com.taptap.sdk.leaderboard.TapTapLeaderboard;
import com.taptap.sdk.leaderboard.SubmitScoresRequest;
import com.taptap.sdk.leaderboard.LeaderboardCallback;
import com.taptap.sdk.leaderboard.SubmitScoresResponse;
...
TapTapLeaderboard.submitScores(
    this, // Activity
    scores,
    new LeaderboardCallback<SubmitScoresResponse>() {
        @Override
...
TapTapLeaderboard.submitScores(
    activity = this,
    scores = scores,
    callback = object : LeaderboardCallback<SubmitScoresResponse> {
...
```java
import com.taptap.sdk.leaderboard.TapTapLeaderboard;
import com.taptap.sdk.leaderboard.LeaderboardCollection;
import com.taptap.sdk.leaderboard.LeaderboardCallback;
import com.taptap.sdk.leaderboard.LeaderboardScoreResponse;
...
TapTapLeaderboard.loadLeaderboardScores(
    ...
    new LeaderboardCallback<LeaderboardScoreResponse>() {
        @Override
...
TapTapLeaderboard.loadLeaderboardScores(
    ...
    callback = object : LeaderboardCallback<LeaderboardScoreResponse> {
...
import com.taptap.sdk.leaderboard.LeaderboardCollection;
import com.taptap.sdk.leaderboard.LeaderboardCallback;
import com.taptap.sdk.leaderboard.UserScoreResponse;
...
TapTapLeaderboard.loadCurrentPlayerLeaderboardScore(
    ...
    LeaderboardCollection.PUBLIC, // 总榜
    null, // periodToken - 时间周期标识
    new LeaderboardCallback<UserScoreResponse>() {
        @Override
...
TapTapLeaderboard.loadCurrentPlayerLeaderboardScore(
    ...
    leaderboardCollection = LeaderboardCollection.PUBLIC, // 总榜
    periodToken = null, // 时间周期标识
    callback = object : LeaderboardCallback<UserScoreResponse> {
...
排行榜 SDK 的所有异步操作都通过 `LeaderboardCallback` 返回结果，开发者需要在 `onFailure` 方法中处理错误情况。
...
```kotlin
object : LeaderboardCallback<LeaderboardScoreResponse> {
    override fun onSuccess(data: LeaderboardScoreResponse) {
        // 处理成功结果
    }
