...
- 完成[页面搭建](/sdk/game-record/guide-page-editor)后，可在**开发者中心 > 你的游戏 > 游戏服务 > 游戏角色查询 > 角色页搭建 > 接口文档下载**获取完整字段请求示例
:::
...
| 接口 | 数据模型 | 适用范围 | 对应页面模块 |
|---------|---------|---------|------------|
| [角色资料推送](#角色资料推送) | 每个角色一条记录 | 角色昵称、等级、头像 ID、展示 ID、区服、职业等基础展示属性 | **角色卡片区域**（角色页顶部）<br/>例如：展示角色头像、昵称、等级、区服信息 |
