...
"com.taptap.tapsdk.unity.moment",
]}
githubDeps={[
...
{package: "com.taptap.tapsdk.unity.moment", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/Moment#${v4SDKVersions.taptap.unity}`}
]}
unitypackageModules={[
{name: "TapSDK_Core.unitypackage", desc: "TapTapSDK 核心模块，必选"},
{name: "TapSDK_Login.unitypackage", desc: "TapTapSDK 登录模块，必选"},
{name: "TapSDK_Moment.unitypackage", desc: "TapTapSDK 内嵌动态模块，必选"},
]}/>
