...
Unity & Android 一般通过 Gradle & AGP 进行构建，所以对于 Unity & Android 项目，需要确保 Gradle 和 AGP 的版本兼容，TapSDK 对 Gradle 和 AGP 的版本要求如下：
...
### Failed to transform retrofit2-1.0.4.jar

解决方案：

1. Unity 开启自定义 Gradle 模板，如图：

![](https://img.tapimg.com/market/images/0b7dd17074a80e67d29fa073929c0eed.png)

2. 定位 `Assets/Plugins/Android/launcherTemplate.gradle` 文件，如图：

![](https://img.tapimg.com/market/images/2d31120fb4678b5364f29fa0e2b2db98.png)

3. 打开 `launcherTemplate.gradle` 文件，找到 compileSdkVersion，修改为 33，如图：

![](https://img.tapimg.com/market/images/e258785a591ae31f4ce722da719a1dae.png)