...
:::tip
PC 端云存档功能，**使用前需接入启动校验**，具体参考 [TapTap PC 端集成](/sdk/access/pc-quickstart/) 文档
:::
...
{package: "com.taptap.sdk.cloudsave", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/CloudSave#${v4SDKVersions.taptap.unity}`}
]}
unitypackageModules={[
