...
{package: "com.taptap.tapsdk.unity.iap", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/IAP#${v4SDKVersions.taptap.unity}`}
]}
unitypackageModules={[
{name: "TapSDK_Core.unitypackage", desc: "TapTapSDK 核心模块，必选"},
{name: "TapSDK_IAP.unitypackage", desc: "TapTapSDK 模块IAP，必选"},
]}/>
...
:::tip
订单超过 30 分钟未支付，订单状态会设置为「超时关闭」，该情况无回调通知。
:::
