...
- 参照 [应用包名和签名信息]( /sdk/access/get-ready/#配置签名证书) 配置包名和签名
...
{package: "com.taptap.sdk.iap", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/IAP#${v4SDKVersions.taptap.unity}`}
]}
unitypackageModules={[
