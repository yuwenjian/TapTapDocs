...
systemNpmDeps={"\"com\.unity\.purchasing\":\"3\.1\.0\", //TapTap IAP 所须依赖\n\"com\.taptap\.sdk\.core\":\"4\.5\.1-beta\.2\",\n\"com\.taptap\.sdk\.iap\":\"4\.5\.1-beta\.2\""}
npmDeps={[
]}
githubDeps={[
{package: "com.taptap.sdk.core", url: `https://github.com/taptap/TapSDKCore-Unity.git#${v4SDKVersions.tapIAP.unity}`},
{package: "com.taptap.sdk.iap", url: `https://github.com/taptap/TapSDKLIAP-Unity.git#${v4SDKVersions.tapIAP.unity}`}
]}
unitypackageModules={[
