...
- 参照 [开发者中心配置](/sdk/access/get-ready/) 所述创建 app，配置 app 参数
- 参照 [集成指南](/sdk/integration-guides/android) 配置包名和签名
...
TapTap 登录模块依赖于 TapTapSDK 初始化，具体参考 [TapSDK 集成]( /sdk/integration-guides/android#初始化)
