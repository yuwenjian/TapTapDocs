...
"com.taptap.tapsdk.unity.review",
]}
githubDeps={[
...
{package: "com.taptap.tapsdk.unity.review", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/Review#${v4SDKVersions.taptap.unity}`}
]}
unitypackageModules={[
{name: "TapSDK_Core.unitypackage", desc: "TapTapSDK 核心模块，必选"},
{name: "TapSDK_Review.unitypackage", desc: "TapTapSDK 评价模块，必选"},
]}/>
