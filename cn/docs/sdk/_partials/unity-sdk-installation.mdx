...
{`"dependencies":{
${props.systemNpmDeps ? ("   " + props.systemNpmDeps + "\n") : ""}   ${props.npmDeps.map(dep => `"${dep.replace('com.taptap.sdk.', 'com.taptap.sdk.')}":"${v4SDKVersions.taptap.unity}",`).join('\n   ')}
}`}
</CodeBlock>
...
<CodeBlock language="json">
{`"dependencies":{
${""}   ${props.githubDeps.map(dep => `"${dep.package.replace('com.taptap.sdk.', 'com.taptap.sdk.')}":"${dep.url}",`).join('\n   ')}
}`}
</CodeBlock>
