...
"com.taptap.tapsdk.unity.achievement",
...
{package: "com.taptap.tapsdk.unity.achievement", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/Achievement#${v4SDKVersions.taptap.unity}`}
]}
unitypackageModules={[
{name: "TapSDK_Core.unitypackage", desc: "TapTapSDK 核心模块，必选"},
{name: "TapSDK_Login.unitypackage", desc: "TapTapSDK 登录模块，必选"},
{name: "TapSDK_Achievement.unitypackage", desc: "TapTapSDK 成就模块，必选"},
]}/>
...
@interface GameMainController () <TapTapAcheievementCallback>
