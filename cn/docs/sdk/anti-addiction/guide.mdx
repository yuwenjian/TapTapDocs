...
"com.taptap.tapsdk.unity.compliance",
]}
githubDeps={[
...
{package: "com.taptap.tapsdk.unity.compliance", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/Compliance#${v4SDKVersions.taptap.unity}`}
]}
unitypackageModules={[
{name: "TapSDK_Core.unitypackage", desc: "TapTapSDK 核心模块，必选"},
{name: "TapSDK_Login.unitypackage", desc: "TapTapSDK 登录模块，必选"},
{name: "TapSDK_Compliance.unitypackage", desc: "TapTapSDK 合规认证模块，必选"},
]}/>
...
3. 将工程 Pods 目录下 `TapTapComplianceSDK/Frameworks/TapTapComplianceResource.bundle` 和 `TapTapLoginSDK/Frameworks/TapTapLoginResource.bundle`
   等资源文件导入工程中
