...
<CodeBlock language="json">
  {`"dependencies":{
    ...
    "com.taptap.tapsdk.unity.login":"https://github.com/taptap/tapsdk-unity-dist.git?path=/Login#${v4SDKVersions.taptap.unity}",
    "com.taptap.tapsdk.unity.compliance":"https://github.com/taptap/tapsdk-unity-dist.git?path=/Compliance#${v4SDKVersions.taptap.unity}",
