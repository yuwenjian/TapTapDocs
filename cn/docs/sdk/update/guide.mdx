...
"com.taptap.tapsdk.unity.update",
]}
githubDeps={[
...
{package: "com.taptap.tapsdk.unity.update", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/Update#${v4SDKVersions.taptap.unity}`}
]}
unitypackageModules={[
{name: "TapSDK_Core.unitypackage", desc: "TapTapSDK 核心模块，必选"},
{name: "TapSDK_Update.unitypackage", desc: "TapTapSDK 更新唤起模块，必选"},
]}/>
