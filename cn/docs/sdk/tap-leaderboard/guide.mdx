...
"com.taptap.tapsdk.unity.leaderboard",
]}
githubDeps={[
...
{package: "com.taptap.tapsdk.unity.leaderboard", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/Leaderboard#${v4SDKVersions.taptap.unity}`}
]}
unitypackageModules={[
