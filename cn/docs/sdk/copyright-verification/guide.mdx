...
npmDeps={[
    ...
    "com.taptap.tapsdk.unity.license",
]} 
githubDeps={[
    ...
    {package: "com.taptap.tapsdk.unity.license", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/License#${v4SDKVersions.taptap.unity}`},
]}
unitypackageModules={[
...
请确保：
- DLC 商品已正确创建并审核通过，否则 DLC 查询和购买不会成功。DLC 商品配置事项详见 [DLC 商品文档](/store/buyout/dlc-products)。
