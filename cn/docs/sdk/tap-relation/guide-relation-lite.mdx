...
{package: "com.taptap.sdk.relationlite", url: `https://github.com/taptap/TapSDKRelationLite-Unity.git#${v4SDKVersions.taptap.unity}`}
]}
unitypackageModules={[
{name: "TapSDK_Core.unitypackage", desc: "TapTapSDK 核心模块，必选"},
{name: "TapSDK_Login.unitypackage", desc: "TapTapSDK 登录模块，必选"},
{name: "TapSDK_RelationLite.unitypackage", desc: "TapTapSDK 好友Lite模块，必选"},
]}/>
