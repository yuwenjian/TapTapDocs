...
"com.taptap.tapsdk.unity.relation",
]}
githubDeps={[
...
{package: "com.taptap.tapsdk.unity.relation", url: `https://github.com/taptap/tapsdk-unity-dist.git?path=/Relation#${v4SDKVersions.taptap.unity}`}
]}
unitypackageModules={[
