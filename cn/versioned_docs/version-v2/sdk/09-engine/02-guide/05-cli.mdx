...
- 在浏览器中打开 [http://localhost:3000](http://localhost:3000)，进入 web 应用的首页。
- 在浏览器中打开 [http://localhost:3001](http://localhost:3001)，进入云引擎云函数和 Hook 函数调试界面。
...
`lean-cli` 是开源项目，基于 [Apache](https://github.com/leancloud/lean-cli/blob/master/LICENSE.txt) 协议，源码托管在  [https://github.com/leancloud/lean-cli](https://github.com/leancloud/lean-cli)，欢迎大家贡献。
